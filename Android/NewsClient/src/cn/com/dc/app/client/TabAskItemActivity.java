 ...
 * 
 */
public class TabAskItemActivity extends ActivityGroup {
			...
			if(isChecked)
			{
				switch (buttonView.getId()) {
					case R.id.main_footbar_news :
						startActivity(new Intent(TabAskItemActivity.this, TabNewsItemActivity.class));
						finish();
						break;
			...
			switch (v.getId()) {
				case R.id.btnAir :
					if (tab) {
						...
						TabAskItemActivity.this.sendBroadcast(intent);
