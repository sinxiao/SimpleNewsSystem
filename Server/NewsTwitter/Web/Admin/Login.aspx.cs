    ...
    public partial class Login : System.Web.UI.Page
    {
        ...
        private void btnLogin_Click(object sender, System.Web.UI.ImageClickEventArgs e)
        {
            ...
            if ((Session["PassErrorCountAdmin"] != null) && (Session["PassErrorCountAdmin"].ToString() != ""))
            {
                ...
                if (PassErroeCount > 30)
                {
                    txtUsername.Disabled = true;
                    txtPass.Disabled = true;
                    btnLogin.Enabled = false;
                    this.lblMsg.Text = "对不起，你错误登录了三0次，系统登录锁定！";
                    return;
                }
          ...
          //  AccountsPrincipal newUser = AccountsPrincipal.ValidateLogin(userName, Password);
            WoeMobile.Model.manager admin = new WoeMobile.Model.manager();
            ...
            admin.pwdword = Password;
            
            WoeMobile.Model.manager newUser = WoeMobile.BLL.BLLManager.manager.loginWithEmail(userName,Password);
