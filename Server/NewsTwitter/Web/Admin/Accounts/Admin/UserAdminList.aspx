                                ...
                                <td bgcolor='<%=Application[Session["Style"].ToString()+"xtable_bgcolor"]%>'>
                                    <asp:DataGrid ID="DataGrid1" runat="server" Width="100%" AutoGenerateColumns="False"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateColumn SortExpression="idmanager" HeaderText="用户名">
                                                <ItemTemplate><a href='../../Agent/Role/RoleAssignment.aspx?UserID=<%# DataBinder.Eval(Container, "DataItem.idmanager") %>&PageIndex=<%# DataGrid1.CurrentPageIndex %>'>
                                                    <%# DataBinder.Eval(Container, "DataItem.username")%>
                                                </a></ItemTemplate>
                                            </asp:TemplateColumn>
                                            <asp:BoundColumn DataField="realname" SortExpression="realname" ReadOnly="True" HeaderText="真实姓名">
                                            </asp:BoundColumn>
                                            <asp:BoundColumn DataField="QQ" SortExpression="QQ" ReadOnly="True" HeaderText="QQ">
                                            ...
                                            <asp:TemplateColumn SortExpression="to_id" HeaderText="所属公司">
                                             <ItemTemplate>
                                                    <%# DataBinder.Eval(Container, "DataItem.org_name")%>
                                              </ItemTemplate>
                                            </asp:TemplateColumn>
                                            <asp:BoundColumn DataField="u_code" HeaderText="员工编号"></asp:BoundColumn>
                                            <asp:BoundColumn DataField="rname" HeaderText="用户角色"></asp:BoundColumn>
                                            <asp:BoundColumn DataField="nick_name" HeaderText="前台用户名"></asp:BoundColumn>
                                            ...
                                            <asp:BoundColumn Visible="False" DataField="idmanager" ReadOnly="True" HeaderText="用户ID">
                                                <HeaderStyle Width="30px"></HeaderStyle>
                                            </asp:BoundColumn>
                                        </Columns>
