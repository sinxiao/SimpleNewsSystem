...
namespace Maticsoft.Web.Accounts.Admin
{
    public partial class UserAdminList : System.Web.UI.Page//Maticsoft.Web.Accounts.MoviePage
    {
        ...
        protected void dataBind()
        {
            ...
            //}
            ds = WoeMobile.BLL.BLLManager.manager.GetManagerDetail();
        ...
        protected void DataGrid1_ItemDataBound(object sender, System.Web.UI.WebControls.DataGridItemEventArgs e)
        {
            ...
            switch (e.Item.ItemType)
            {
                ...
                case ListItemType.AlternatingItem:
                    ...
                    string DepartmentID = "";//+DataBinder.Eval(e.Item.DataItem, "to_id");
                    
                    string UserType = "";//+DataBinder.Eval(e.Item.DataItem, "role_id");
                    if (DepartmentID == "-1")
                    {
        ...
        protected void DataGrid1_ItemCommand(object source, System.Web.UI.WebControls.DataGridCommandEventArgs e)
        {
            ...
            switch (btn)
            {
                case "BtnEdit":
                    ...
                    //{
                    //    String text = e.Item.Cells[i].Text;
                    //}
                 // e.Item.DataItem
                  //  System.Console.WriteLine(e.Item.Cells[10].Text.Trim());
                    
                   int userID1 = int.Parse(e.Item.Cells[count-1].Text.Trim());
                    Response.Redirect("../userupdate.aspx?List=List&userid=" + userID1);
                    break;
                case "BtnDel":
                    int userID2 = int.Parse(e.Item.Cells[count - 1].Text.Trim());
