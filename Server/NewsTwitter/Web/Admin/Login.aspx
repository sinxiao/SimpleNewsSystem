                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td align="right" valign="top">
                                                <br>
                                                &nbsp;
                                                <img height="9" src="images/point07.gif" width="13" border="0"><a href="#" onclick="window.external.addFavorite('http://www.baidu.com','新闻管理系统')">加入收藏</a>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                                            ...
                                            <table cellspacing="0" cellpadding="0" border="0">
                                                <tr>
                                                    <td width="210" height="25" valign="top">
                                                        用户名：
                                                        <input class="nemo01" tabindex="1" maxlength="22" size="22" name="user" value="admin@admin.com" id="txtUsername"
                                                ...
                                                <tr>
                                                    <td valign="bottom" height="12">
                                                        密&nbsp;&nbsp; 码：
                                                        <input name="user" type="password" class="nemo01" value="admin" tabindex="1" 
